 ...
 */
$GLOBALS['TL_DCA']['tl_page']['config']['onload_callback'][] = ['tl_page_ls_cnc_languageSelector', 'insertSelectorForCorrespondingMainLanguagePage'];

$GLOBALS['TL_DCA']['tl_page']['list']['label']['label_callback'] = ['tl_page_ls_cnc_languageSelector', 'showMessageIfNoCorrespondingPageSelected'];

$GLOBALS['TL_DCA']['tl_page']['fields']['ls_cnc_languageSelector_correspondingMainLanguagePage'] = [
    'label' => &$GLOBALS['TL_LANG']['tl_page']['ls_cnc_languageSelector_correspondingMainLanguagePage'],
    'exclude' => true,
    'inputType' => 'select',
    'options_callback' => ['tl_page_ls_cnc_languageSelector', 'getCorrespondingMainLanguagePages'],
    'eval' => ['tl_class' => 'w50'],
...
class tl_page extends Backend
{
    ...
    public function insertSelectorForCorrespondingMainLanguagePage($dc): void
    {
        if ('edit' === $this->Input->get('act')) {
            /*
        ...
        } elseif ('editAll' === $this->Input->get('act')) {
            /*
    ...
    protected function createPageOptionsArray($intId = 0, $level = -1): void
    {
